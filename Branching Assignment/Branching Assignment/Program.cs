...
namespace Branching_Assignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (Weight > 50) Console.WriteLine("Package too heavey to be shipped via Package Express.");
            ...
            if (Width + Height + Length > 50) Console.WriteLine("Package too big to be shipped via Package Express.");
            int Total = (Width * Height * Length);
            decimal Quote = (Total) / (Weight);
